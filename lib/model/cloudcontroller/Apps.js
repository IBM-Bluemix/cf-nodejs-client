...
class Apps extends CloudControllerBase {
    ...
    */
     ...
     * {@link https://apidocs.cloudfoundry.org/236/apps/updating_an_app.html}
     *
     * @param  {String} appGuid     [App guid]
     * @param  {JSON}   envVars     [Environment Variables to Set]
     * @return {JSON}               [Service Bindings]
     */
    setEnvironmentVariables (appGuid, envVars) {
